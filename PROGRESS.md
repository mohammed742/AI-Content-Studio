...
- **Phase 2.5 is complete** — all 7 slices done. Committed `b2d3cdf` + pushed to `origin/main`. Left **In Progress** (board has no Needs Review); DEV-64 → Done pending human QA.
