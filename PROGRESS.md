...
- **UI work**: **no** this slice (DEV-27 is a pure `src/lib/` service — no route, no component; consumed by later Phase-3 slices/API). No `DESIGN.md` read needed.
- **Files modified this session (DEV-27, 2026-07-23)**:
