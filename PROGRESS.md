...
- **Not committed**: nothing committed/pushed this session — commits/pushes are interactive-at-human-request per AGENTS.md and the human hasn't asked. DEV-35 left **In Progress** (no "Needs Review" status); completion comment = review signal.
