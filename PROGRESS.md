...
- **UI work**: **no** this slice (DEV-31 is a pure `src/lib/` service + a routing-table entry — no route, no component; consumed by DEV-33). No `DESIGN.md` read needed. (⚠️ DEV-33, next, IS a UI slice.)
